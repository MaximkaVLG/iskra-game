...
const CACHE=PREFIX+'pet-home-v1';
const HOME=BASE.href;
const ASSETS=['./','index.html','style.css','readability.css','play.css','arena.css','iphone.css','app.js','app.js?v=pet-home-v1','progress.js?v=pet-home-v1','course.js','logic.js','progress.js','play-content.js','gameplay.js','math-view.js','arena.js','arena-ui.js','auto-advance.js','pets.js','expeditions.js','pet-ui.js','pets.css','assets/iskra-home-atlas.png','assets/home-canopy.svg','assets/iskra.png','assets/glade.png','assets/chest.png','favicon.svg','manifest.webmanifest','assets/icon-192.png','assets/icon-512.png','assets/manrope-regular.ttf','assets/manrope-bold.ttf','assets/stix-two-math.ttf'].map(path=>new URL(path,BASE).href);
