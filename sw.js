...
const CACHE=PREFIX+'arena-v4';
const HOME=BASE.href;
const ASSETS=['./','index.html','style.css','readability.css','play.css','arena.css','app.js','course.js','logic.js','progress.js','play-content.js','gameplay.js','arena.js','arena-ui.js','auto-advance.js','assets/iskra.png','assets/glade.png','assets/chest.png','favicon.svg','manifest.webmanifest','assets/icon-192.png','assets/icon-512.png','assets/manrope-regular.ttf','assets/manrope-bold.ttf'].map(path=>new URL(path,BASE).href);
